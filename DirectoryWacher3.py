...
# and also display size of that file.
...
#input - python DirectoryWatcher3.py Data   # the folder data is present same location of script file
#or - python DirectoryWatcher3.py "absolute path folder which is not present with script file location"